...
PRODUCT_COPY = {
    "zh": {
        ...
        "quality_duplicate_reason_exact_text": "（与卡片 {number} 完全相同）",
        "quality_duplicate_reason_normalized_text": "（与卡片 {number} 仅格式不同）",
        "quality_duplicate_reason_shared_source_token_overlap": "（与卡片 {number} 表述高度接近）",
        "quality_duplicate_reason_shared_source_character_overlap": "（与卡片 {number} 文字高度接近）",
    ...
    "en": {
        ...
        "quality_duplicate_reason_exact_text": "(same as Card {number})",
        "quality_duplicate_reason_normalized_text": "(format-only difference from Card {number})",
        "quality_duplicate_reason_shared_source_token_overlap": "(very similar wording to Card {number})",
        "quality_duplicate_reason_shared_source_character_overlap": "(very similar text to Card {number})",
